...
driver.find_element(id: 'user_login').send_keys 'testuser2'
...
driver.find_element(id: 'user_mail').send_keys 'vlmiruby+2@gmail.com'
...
driver.find_element(name: 'logout').click #logout

driver.find_element(class: 'login').click #login
driver.find_element(id: 'username').send_keys 'testuser2'
...
driver.find_element(class: 'projects').click #add user (doesnt work)
driver.find_element(id: 'tab-members').click
driver.find_element(id: 'principal_search').send_keys 'testuser2'
...
driver.find_element(css: '#member-90327 > td.buttons > a.icon.icon-edit').click #change users role (doesnt work)
...
driver.find_element(id: 'issue_tracker_id').click label=Feature
driver.find_element(id: 'issue_subject').send_keys 'feature1'
driver.find_element(name: 'commit').click

driver.find_element(link: 'Новая задача').click #create support
driver.find_element(id: 'issue_tracker_id').click label=support
driver.find_element(id: 'issue_subject').send_keys 'support1'
driver.find_element(name: 'commit').click

driver.find_element(link: 'Задачи').click #check visibility
