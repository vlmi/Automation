...
#login1 variable = testuser1+(random)
#login2 variable = testuser1+1+(random)
#email1 variable = vlmiruby+(random)@gmail.com
#email2 variable = vlmiruby+1+(random)@gmail.com
...
driver.find_element(id: 'user_login').send_keys 'testuser13'
...
driver.find_element(id: 'user_mail').send_keys 'vlmiruby+13@gmail.com'
...
driver.find_element(id: 'username').send_keys 'testuser13'
...
driver.find_element(id: 'project_name').send_keys 'TestProject13'
driver.find_element(name: 'commit').click

driver.find_element(id: 'tab-members').click #add user
driver.find_element(id: 'principal_search').send_keys 'testuser1'
